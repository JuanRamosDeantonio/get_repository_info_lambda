...
def parse_lambda_event(event: Dict[str, Any], context: Any) -> Tuple[str, Any, str, Optional[str]]:
    ...
    try:
        ...
        operation, provider, config, path, iswiki = validate_request_data(body)
        ...
        return operation, manager, provider, path, iswiki
...
def parse_local_event(event_file: Optional[str] = None) -> Tuple[str, Any, str, Optional[str]]:
    ...
    try:
        ...
        operation, provider, config, path, iswiki = validate_request_data(event_data)
